...
gopherbot is capable of opening backport issues according to [MinorReleases](https://golang.org/wiki/MinorReleases.md) in response to comments like the following on the main issue.
