...
* [Go Books](https://github.com/dariubs/GoBooks.md)
...
# German
  * **Programmierung in Google Go** (not available for buying any more)
    ...
    * Reference (Google Books.md): https://books.google.de/books?id=E4IL5dT1yLsC&printsec=frontcover&hl=de#v=onepage&q&f=false
...
# Italian
  * **Programmare in Linguaggio Go**
    ...
    * Reference (Google Books.md): https://play.google.com/store/books/details/Renato_Mite_Programmare_in_Linguaggio_Go?id=4Ag6DQAAQBAJ
    * Reference (Kobo Books.md): https://store.kobobooks.com/it-it/ebook/programmare-in-linguaggio-go
